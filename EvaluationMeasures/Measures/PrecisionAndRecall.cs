...
namespace MyMediaLite.Eval.Measures
{
	...
	///   </para>
	/// </remarks>
	public static class PrecisionRecallAndF<T>
	{
		...
		public static double AP(IList<T> ranked_items, ICollection<T> correct_items)
		{
			int hit_count       = 0;
		...
		public static Dictionary<int, double> PrecisionAt(
			IList<T> ranked_items,
			ICollection<T> correct_items,
			IList<int> ns)
		{
		...
		public static double PrecisionAt(
			IList<T> ranked_items, ICollection<T> correct_items, int n)
		{
		...
		public static Dictionary<int, double> RecallAt(
			IList<T> ranked_items, ICollection<T> correct_items, IList<int> ns)
		{
		...
		public static double FMeasureAt(IList<T> ranked_items, ICollection<T> correct_items, int n)
		{
			var precision = PrecisionAt(ranked_items, correct_items, n);
			var recall = RecallAt(ranked_items, correct_items, n);
			return 2 * (precision * recall) / ((precision + recall) == 0 ? 1 : precision + recall);
		}
	}
}
